...
import { ImTrophy, ImCross } from "react-icons/im";
    ...
    >
      <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
        ...
        <div className="mt-3 text-center">
          <div className="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-wildcolorlight text-gray-600">
            <ImTrophy />
          </div>
          ...
          <div className="mt-2 px-7 py-3">
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="items-center px-4 py-3">
                <button
                  type="submit"
                  className="px-4 py-2 bg-wildcolor text-white text-base font-medium rounded-md w-full shadow-sm hover:bg-wildcolorlight focus:outline-none focus:ring-2 focus:ring-gray-300"
                >
                  Ajouter
                </button>
              </div>
